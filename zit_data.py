...
DEFAULT_VESPERA_PROMPT_PREFIX = (
    ...
    "Full soft naturally contoured satin-sheen lips with a defined philtrum and sharp cupid's bow, natural white teeth, and an exact 1mm beauty mark positioned just above the left corner of her upper lip. "
...
VESPERA_VARIATIONS = [
    (
        ...
        "Deep-set almond hazel-green eyes with amber-gold striations and soft-smudged smoky eyeliner shadow. "
        "soft naturally contoured satin lips with defined cupid's bow, 1mm mole above left upper lip corner, radiant olive skin with natural epidermal pores. "
    ...
    (
        ...
        "Almond hazel-green eyes with amber flecks and dark lash line, defined soft naturally contoured satin lips with sharp cupid's bow, 1mm beauty mark at left lip corner. "
    ...
    (
        ...
        "Full soft naturally contoured satin lips, 1mm upper left beauty mark, luminous olive skin with subsurface dermal warmth and micro-perspiration sheen. "
...
VESPERA_FACE_MICROPACK = (
    ...
    "soft-smudged smoky eyeliner shadow, defined soft naturally contoured satin lips with cupid's bow, 1mm beauty mark near left corner of upper lip, "
...
EXPRESSIONS_POOL_NSFW = [
    ...
    for lips in ["parted soft naturally contoured satin lips", "moist soft naturally contoured lips revealing clean white teeth", "gently bitten lower lip", "soft relaxed satin lips", "subtle lip curl"]
...
EXPRESSIONS_POOL_SFW = [
    ...
    for lips in ["closed defined soft naturally contoured lips", "relaxed natural smile with white teeth", "subtle Jeselnik-style smirk", "defined cupid's bow"]
...
LORA_TIER1_ANCHORS = [
    ...
    for i, (angle_name, pose_desc, rig_key, expr, env_d) in enumerate([
        ("Direct Frontal Portrait", "Direct frontal close-up portrait with shoulders squared, head held straight, chin slightly lowered, eyes engaging camera directly with symmetrical facial framing, sharp nose bridge, cheekbones and jawline in perfect balance", "Roger Deakins (Arri LF 32mm Tungsten)", "a calm, intense direct gaze with parted soft naturally contoured satin lips and clean white teeth slightly visible", "in a high-end minimalist editorial fashion studio with smooth seamless neutral warm-grey backdrop"),
        ("Three-Quarter Profile Right", "Three-quarter close-up portrait angled 30 degrees to the right, head subtly tilted, defining right cheekbone and jawline against neck shadow, gazing slightly off-center", "Denis Villeneuve (Alexa 65 Anamorphic 50mm)", "an enigmatic, heavy-lidded sultry gaze with soft-smudged smoky eyeliner and subtle sardonic half-smile", "in an opulent private penthouse suite overlooking rainy Paris at 3 AM"),
        ("Three-Quarter Profile Left", "Three-quarter close-up portrait angled 30 degrees to the left, head turned toward directional key light, highlighting left cheekbone bone structure and jawline contour", "Wong Kar-Wai (Cooke 40mm f/1.4 Neon)", "a playful knowing half-smile with moist soft satin lips and amber-gold flecks catching neon light", "standing on wet cobblestones of a Montmartre alleyway under warm amber streetlamps"),
        ("Chin On Hand Thoughtful Lean", "Close-up portrait resting delicate chin on curved knuckles of right hand, manicured fingers lightly framing jawline, head angled thoughtfully forward", "Helmut Newton (Hasselblad 80mm B&W High-Fashion)", "a thoughtful, captivating upward gaze with raised arched sable brow and relaxed lips", "editorial fashion studio with smooth seamless warm-grey backdrop"),
        ("Full Profile Right Silhouette", "Sharp 90-degree pure side profile facing right, head held high with straight posture, delicate button nose supratip break, sculpted jawline, lips and forehead contour in razor profile", "David Fincher (Red 8K Leica 27mm Monochromatic)", "a serene composed expression with long curled eyelashes visible in profile and closed satin lips", "neutral studio backdrop with seamless dark charcoal cyclorama wall"),
        ("Full Profile Left Silhouette", "Sharp 90-degree pure side profile facing left, neck extended gracefully, showcasing refined nose bridge, full lip projection, ear geometry and cheekbone contour", "Gordon Willis (Baltar 50mm f/2.0 Low-Key Sepia)", "an alluring contemplative expression gazing forward into warm ambient shadows", "inside an opulent private French boudoir with vintage mirrors and warm ambient shadows"),
        ("Dramatic Low-Angle Head Tilt", "Low-angle close-up looking up, head tilted back slightly with regal confidence, looking down into camera lens, clean jawline, throat, and clavicle contour in sharp focus", "Stanley Kubrick (Zeiss 50mm f/0.7 Candlelit)", "a dominant, sultry half-lidded gaze looking down with a subtle knowing smirk", "in a candlelit luxury suite with carved oak headboard and dark velvet bolsters"),
        ("High-Angle Upward Gaze", "High-angle close-up looking down, head tilted back and chin lifted looking up toward camera, wide almond hazel-green irises capturing bright catchlights", "Quentin Tarantino (Ultra Speed 40mm Punchy)", "a soft intimate breathless gaze with parted lips and dilated hazel pupils", "in a luxury modern duplex with polished dark marble floors and minimalist lighting"),
        ("Left Shoulder Sidelong Look-Back", "Torso rotated 60 degrees away to the right, head turned back over left shoulder with casual elegance, left clavicle and trapezius muscle engaged, looking back over shoulder", "Ridley Scott (Panavision 50mm f/1.4 Anamorphic)", "a sultry sidelong glance over left shoulder with heavy-lidded hazel eyes and parted soft lips", "in a private high-fashion boudoir with deep velvet drapery and warm amber rim lighting"),
        ("Right Shoulder 45-Deg Glance", "Torso rotated 45 degrees away to the left, head turned back over right shoulder, right deltoid and cheekbone in sharp relief, looking back toward viewer", "Michael Mann (Sony CineAlta 28mm Blue Ambient)", "a sharp, witty spark in her eyes paired with an amused confident micro-smirk", "inside a moody high-tech cybernetic sanctuary in Neo-Paris with dark brushed aluminum panels"),
        ("Tilted Head Natural Smile", "Close-up portrait with head tilted playfully 15 degrees to the side, spiral corkscrew curls spilling over cheek, natural joyful energy", "Roger Deakins (Arri LF 32mm Tungsten)", "a radiant magnetic smile with parted lips revealing clean ivory teeth, eyes crinkling with genuine warmth", "in a high-end commercial fashion studio with neutral medium-grey background"),
        ("Hands Framing Face", "Close-up portrait with both manicured hands brought up to frame temples and jawline, delicate fingers gently touching wet ringlet curls framing the cheeks", "Denis Villeneuve (Alexa 65 Anamorphic 50mm)", "an intense hypnotic direct stare engaging the camera through framing fingers", "in an opulent private penthouse suite overlooking rainy Paris at 3 AM"),
        ("Reclining Pillow Overhead", "Bird's-eye overhead close-up portrait, reclining on back with voluminous 3B/3C spiral curls fanned out across dark silk pillow, face framed from above", "Wong Kar-Wai (Cooke 40mm f/1.4 Neon)", "a dreamy, relaxed bedroom gaze looking straight up into the lens with soft natural lips", "in a private high-fashion boudoir with deep velvet drapery and warm amber rim lighting"),
        ("Sarcastic Asymmetrical Half-Smirk", "Three-quarter close-up portrait, one dark sable brow subtly arched, signature knowing asymmetrical half-smirk, head cocked with razor wit", "Helmut Newton (Hasselblad 80mm B&W High-Fashion)", "a wicked, razor-sharp sarcastic micro-smirk with amused hazel eyes and knowing poise", "editorial fashion studio with smooth seamless warm-grey backdrop"),
        ("Chiaroscuro Rim-Lit Profile", "Close-up portrait in deep chiaroscuro, head turned 45 degrees into darkness while sharp directional rim light traces forehead, button nose tip, lips, and jawline contour", "David Fincher (Red 8K Leica 27mm Monochromatic)", "an enigmatic, shadowy intense gaze half-concealed in atmospheric shadow", "neutral studio backdrop with seamless dark charcoal cyclorama wall"),
    ])
]
...
LORA_TIER2_ANATOMY = [
    ...
    for i, (name, pose_desc, expr, attire_d, env_d, rig_k) in enumerate([
        ...
        ("Seated Forward Lean", "Cowboy shot, leaning forward with elbows on knees, resting chin on palm, gazing intensely up at camera, chest and collarbone prominent", "an alluring intimate gaze with parted soft naturally contoured lips and amber flecks", "open silk robe draped off bare shoulders and chest", "in a candlelit luxury suite with carved oak headboard", "Stanley Kubrick (Zeiss 50mm f/0.7 Candlelit)"),
    ])
]
...
LORA_TIER3_WARDROBE = [
    ...
    for i, (name, pose_d, expr_d, attire_text, env_text, rig_key, physics_text) in enumerate([
        ...
        ("Champagne Silk Slip", "High-angle shot looking down from above, seated on deep window sill with knees pulled to chest, rain-streaked glass behind", "a soft dreamy contemplative gaze with relaxed soft naturally contoured lips", "Wearing a champagne-gold fluid silk charmeuse slip dress with spaghetti straps and plunging open back", "in a luxury penthouse overlooking rainy Paris skyline at 3 AM through floor-to-ceiling glass", "Denis Villeneuve (Alexa 65 Anamorphic 50mm)", "luxurious fluid silk charmeuse with high specular sheen rippling over biological contours"),
        ...
        ("White Linen & Cutoffs", "Dynamic outdoor portrait, standing by open French doors on a sunny balcony, sleeves rolled up, hair caught in breeze", "a radiant sun-kissed grin with vibrant eyes and windswept curls", "Wearing an oversized crisp white linen button-down shirt over a neutral silk camisole and tailored pleated high-waisted shorts", "on a private sunlit Parisian balcony overlooking Haussmann zinc rooftops with warm afternoon light", "Roger Deakins (Arri LF 32mm Tungsten)", "breathable open-weave white linen with crisp sunlit transparency, textured cotton weave"),
        ("Black Vinyl Trench", "Dynamic walking street snapshot, striding forward through heavy rain with umbrella tilted back", "a sharp intense editorial gaze focused forward with naturally contoured lips", "Wearing a high-gloss black vinyl belted trench coat with patent leather thigh-high boots", "on glistening wet Boulevard Saint-Germain at night with neon sign reflections", "Helmut Newton (Hasselblad 80mm B&W High-Fashion)", "wet liquid vinyl surface with micro-water rivulets and crisp anamorphic light streaks"),
